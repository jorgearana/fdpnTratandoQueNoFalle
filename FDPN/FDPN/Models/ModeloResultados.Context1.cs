...
namespace FDPN.Models
{
    ...
    public partial class DB_9B1F4C_MVCcompetenciasEntities1 : DbContext
    {
        public DB_9B1F4C_MVCcompetenciasEntities1()
            : base("name=DB_9B1F4C_MVCcompetenciasEntities1")
        {
        }
